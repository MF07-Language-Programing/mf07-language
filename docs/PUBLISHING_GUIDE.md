...
- ✅ Multi-platform (Linux, macOS, Windows via Git Bash/WSL)
...
|--------|-------------|----------|
| `GITHUB_TOKEN` | Auto-generated by GitHub | ✅ Auto |
...
- 🎯 Custom domain for installation (`curl install.mf07.dev | bash`)
- 🎯 Homebrew formula (`brew install mf07`)
- 🎯 Docker images
- 🎯 VS Code extension auto-updater
- 🎯 Canary/nightly builds
- 🎯 Rollback command (`mf upgrade --rollback`)
